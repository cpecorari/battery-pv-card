...
Each of these cards can optionally be hidden (see section _Parameters_).

Note: The settings card is hidden by default when using _entities mode_.
...
If entities have been renamed, this method won’t work. You can still pass individual entities manually (see _Parameters_ section).
